...
exports.Prisma.WeightMeasurementScalarFieldEnum = {
  id: 'id',
  userId: 'userId',
  weightKg: 'weightKg',
  note: 'note',
...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/neil/Projects/my-project/packages/site1/prisma/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/home/neil/Projects/my-project/packages/site1/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null
